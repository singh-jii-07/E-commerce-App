  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-gray-500">Monitor customer transaction amounts, modes, and settlement states</p>
      </div>
                ...
                {filteredOrders.map((o) => (
                  <tr key={o._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <span className="px-2 py-0.5 rounded bg-gray-100 border border-gray-200 font-medium">
                        {o.paymentMethod}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-3 text-gray-500">
                      <span className="flex items-center gap-1">
                        ...
                        {o.paidAt
                          ...
                          : o.orderStatus === "Delivered" && o.paymentMethod === "COD"
