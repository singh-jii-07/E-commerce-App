                  ...
                  <tr key={contact._id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="p-3">
                      <select
                        ...
                        className={`px-2 py-1 rounded border font-semibold text-[10px] cursor-pointer focus:outline-none ${getStatusBadge(contact.status)}`}
                      >
              ...
              <div>
                ...
                <div className="mt-1">
                  <select
                    ...
                    className={`px-3 py-1.5 rounded-lg border text-xs font-bold cursor-pointer focus:outline-none w-full ${getStatusBadge(selectedMessage.status)}`}
                  >
                    <option value="Pending" className="bg-white text-gray-800 font-medium">Pending</option>
                    <option value="Processing" className="bg-white text-gray-800 font-medium">Processing</option>
                    <option value="Completed" className="bg-white text-gray-800 font-medium">Completed</option>
                  </select>
                </div>
              </div>
